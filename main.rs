...
fn lagrange_interpolation(x:Vec<i32>,y:Vec<BigInt>,x_evaluate:i32,n:BigInt)->BigInt{ /*lagrange_interpolation() fun takes 
...
for i in 0..k {
    ...
    sum = sum +(numer*inverse(denom,n.clone()))*y[i].clone();
